...
namespace Pakal
{
	...
	public:
		...
		WindowArgs setup_window(unsigned windowId, const tmath::vector2di& dimensions, bool fullscreen, unsigned bitsPerPixel) override final;
